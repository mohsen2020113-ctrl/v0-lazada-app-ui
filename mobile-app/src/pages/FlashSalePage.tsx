...
export default function FlashSalePage({ navigate }: Props) {
  ...
  return (
    <div className="bg-gray-50 min-h-full">
      <div className="bg-gradient-to-r from-red-500 to-orange-500 px-4 pt-12 pb-6">
        ...
        <p className="text-white/80 text-sm mb-3">Limited quantities — ends in:</p>
        <div className="flex gap-2">
          {[{ v: h, l: 'Hours' }, { v: m, l: 'Mins' }, { v: s, l: 'Secs' }].map(({ v, l }) => (
            <div key={l} className="flex-1 bg-black/30 rounded-xl py-3 text-center text-white">
