...
export const mockProduct: Product = {
  ...
  soldCount: 7600,
  images: [
    '/products/floor-cleaner-1.png',
    '/products/floor-cleaner-2.png',
    '/products/floor-cleaner-3.png',
    '/products/floor-cleaner-4.png',
    '/products/floor-cleaner-5.png',
  ],
  videos: [
    '/products/floor-cleaner-1.png',
    '/products/floor-cleaner-2.png',
  ...
  reviews: [
    {
      ...
      images: ['/products/review-1.png', '/products/floor-cleaner-4.png'],
      date: '2 weeks ago',
    },
    {
      id: '2',
      ...
      images: ['/products/review-1.png', '/products/floor-cleaner-5.png'],
      date: '1 week ago',
    },
  ],
  similarProducts: [
    {
      ...
      reviewCount: 1700,
      soldCount: 1700,
      images: ['/products/umbrella-stand.png'],
    ...
    },
    {
      ...
      reviewCount: 8000,
      soldCount: 8000,
      images: ['/products/cleaning-brush.png'],
      tags: ['Brush', 'Cleaning'],
      specifications: [],
      seller: { name: 'Better Home Life', rating: 97, reviews: 770600 },
      shipping: { method: 'Standard', cost: 0, estimatedDays: 5 },
