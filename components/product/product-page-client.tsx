...
export function ProductPageClient({ product }: { product: Product }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ProductActions 
        sellerId={typeof product.seller === 'string' ? product.seller : product.seller?.name || 'Store'} 
        sellerName={typeof product.seller === 'string' ? product.seller : product.seller?.name || 'Store'} 
        price={product.price} 
        quantity={quantity} 
      />
    </div>
