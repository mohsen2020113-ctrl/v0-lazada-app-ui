...
const ARTryOn = ({ productId }: { productId: string }) => {
    ...
    return (
          <div className="w-full max-w-md mx-auto bg-slate-900 rounded-lg overflow-hidden">
            {!arActive ? (
                    <div className="p-6">
                              <h2 className="text-2xl font-bold text-white mb-4">AR Virtual Try-On</h2>
                              <p className="text-slate-300 mb-6">See how this product looks on you with our augmented reality feature.</p>
                              <button
                    ...
                    <div className="relative">
                              <div className="relative bg-black">
                                {useVideo ? (
                                    <div className="p-8 text-center bg-gradient-to-b from-slate-800 to-slate-900">
                                                    ...
                                                    <h3 className="text-xl font-bold text-white mb-2">AR Preview Video</h3>
                                                    <p className="text-slate-300 mb-6">Watch how this product looks in action</p>
                                                    <video
                              ...
                              <div className="p-4 bg-slate-800">
                                          <p className="text-slate-300 text-sm">{hasCamera ? 'Camera Feed' : 'AR Preview Video'}</p>
                                {!hasCamera && (
                                    <p className="text-pink-400 text-xs mt-2">Camera not available, showing video preview</p>
                                          )}
                              </div>
                    </div>
                )}
